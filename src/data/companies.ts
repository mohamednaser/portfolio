...
export const companies = {
  lynk: {
    id: 'lynk',
    name: 'Lynk',
    src: '/assets/images/companies/lynk-logo.png',
    href: 'https://lynk.sa/',
    kind: 'employer',
  },
  carefer: {
    id: 'carefer',
    name: 'Carefer',
    src: '/assets/images/companies/carefer-logo.png',
  ...
  ynmo: {
    id: 'ynmo',
    name: 'Ynmo',
    src: '/assets/images/companies/ynmo-logo.png',
  ...
  'mitch-designs': {
    id: 'mitch-designs',
    name: 'Mitch Designs',
    src: '/assets/images/companies/mitchdesigns-logo.png',
  ...
  'nile-code': {
    id: 'nile-code',
    name: 'Nile Code',
    src: '/assets/images/companies/nilecode-logo.png',
  ...
  'integrated-development': {
    ...
    src: '/assets/images/companies/integrated-development.png',
    kind: 'employer',
  },
  'brilliance-tech': {
    id: 'brilliance-tech',
    name: 'Brilliance Tech',
    src: '/assets/images/companies/brilliance-tech-logo.png',
    kind: 'employer',
  },
  microverse: {
    id: 'microverse',
    name: 'Microverse',
    src: '/assets/images/companies/microverse.png',
  ...
  'johnson-johnson': {
    ...
    src: '/assets/images/companies/johnson-johnson-logo.png',
    kind: 'client',
  },
  total: {
    id: 'total',
    name: 'TOTAL',
    src: '/assets/images/companies/total-logo.png',
    background: '#000000',
    kind: 'client',
  },
  okhtein: {
    id: 'okhtein',
    name: 'Okhtein',
    src: '/assets/images/companies/okhtein-logo.png',
